function CReelColumn(iIndex,iXPos,iYPos,iDelay){
    ...
    this.initContainer = function(iXPos,iYPos){
        ...
        for(var i=0;i<NUM_ROWS;i++){
             ...
             var oSprite = createSprite(s_aSymbolData[iRandSymbol], "static",0,0,SYMBOL_IMAGE_SIZE,SYMBOL_IMAGE_SIZE);
             oSprite.stop();
             oSprite.x = iX;
             oSprite.y = iY;
    ...
    this._setSymbol = function(aSymbols){
        ...
        for(var i=0;i<aSymbols.length;i++){
            var oSprite = new createjs.Sprite(s_aSymbolData[aSymbols[i]], "static",0,0,SYMBOL_IMAGE_SIZE,SYMBOL_IMAGE_SIZE);
             oSprite.stop();
             oSprite.x = iX;
             oSprite.y = iY;
             _oContainer.addChild(oSprite);
