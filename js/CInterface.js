function CInterface(iCurBet,iTotBet,iMoney){
    ...
    var _oCoinText;
    var _oMoneyText;
    var _oMoneyValueText;

    var _oTotalBetText;
    var _oTotalBetValueText;
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        _oSpinBut = new CTextButton(950 + (oSprite.width/2),650 ,oSprite,TEXT_SPIN,FONT_GAME,"#ffffff",30,s_oStage);  
        ...
        _oMoneyText = new CTLText(s_oStage, 
                        150, CANVAS_HEIGHT- 80, 100, 50, 
                        24, "right", "#f6fa31", FONT_GAME, 1,
                        0, 0,
                        TEXT_MONEY,
                        true, true, true,
                        false );

        _oMoneyValueText = new CTLText(s_oStage, 
            260, CANVAS_HEIGHT- 80, 400, 50, 
        ...
        //             false );
                    ...
                    //150, CANVAS_HEIGHT- 80, 400, 50
                    //Ori Pos : 825, CANVAS_HEIGHT - 120, 175, 30, 
        _oTotalBetText = new CTLText(s_oStage, 
                    150, CANVAS_HEIGHT - 50, 175, 30, 
                    24, "center", "#ffffff", FONT_GAME, 1,
                    0, 0,
                    TEXT_BET +" "+iTotBet.toFixed(2),
                    true, true, false,
                    false );

                    //Ori pos : 1049, CANVAS_HEIGHT - 120, 132, 30
        _oWinText = new CTLText(s_oStage, 
                    500, CANVAS_HEIGHT - 50, 132, 30, 
    ...
    this.refreshMoney = function(iMoney){
        _oMoneyValueText.refreshText(iMoney.toFixed(2)+TEXT_CURRENCY);
    };
