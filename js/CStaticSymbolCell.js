function CStaticSymbolCell(iRow,iCol,iXPos,iYPos){
    ...
    this._init = function(iRow,iCol,iXPos,iYPos){
        ...
        for(var i=0;i<NUM_SYMBOLS;i++){
            var oSprite = createSprite(s_aSymbolAnims[i], "static",0,0,SYMBOL_IMAGE_SIZE,SYMBOL_IMAGE_SIZE);
            oSprite.stop();
            oSprite.x = iXPos;
            oSprite.y = iYPos;
        ...
        var oData = {   // image to use
                        ...
                        frames: {width: SYMBOL_IMAGE_SIZE, height: SYMBOL_IMAGE_SIZE, regX: 0, regY: 0}, 
                        animations: {  static: [0, 1],anim:[1,19] }
        };

        var oSpriteSheet = new createjs.SpriteSheet(oData);
        
        _oWinningFrame = new createjs.Sprite(oSpriteSheet, "static",0,0,SYMBOL_IMAGE_SIZE,SYMBOL_IMAGE_SIZE);
        _oWinningFrame.stop();
